...
b1 = pd.Series(depDelayAvs).describe()['mean'] - corr * pd.Series(flightCounts).describe()['mean']
print('Correlation coefficient = ', corr)
plt.scatter(flightCounts, depDelayAvs)
plt.plot(flightCounts[7:15], (b1 + corr * np.array(flightCounts))[7:15])
plt.xlabel("Hour")
plt.ylabel("Delay")
plt.savefig('D:\\MFK\\correlation.jpg')
plt.clf()
print('Regression equation:', corr, '* x +', b1)
